...
inventory: {
  ...
  TEXT_INVENTORY_SUBTITLE: "Manage stock across {{count}} regional warehouses.",
  ...
  TEXT_LOW_STOCK_BANNER_TITLE: "{{count}} items are running low across your warehouses",
  TEXT_LOW_STOCK_BANNER_SUBTITLE: "Review the list below and restock before you run out.",
  TEXT_LOW_STOCK_EMPTY: "No low-stock items right now",
  TEXT_LOW_STOCK_EMPTY_SUBTITLE: "All products are above their alert threshold. Nice work!",
